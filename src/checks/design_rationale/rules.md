...
5. NO DUPLICATION. If the file already has a section owning this decision, it must be folded
   into that one rather than added alongside it.

6. NO ENUMERATED VALUES, AND NO HOW THE CODE CAN STATE ITSELF. No lists of fields, columns,
...
7. NO SPEC RESTATEMENT. Paraphrasing an RFC, grammar, character set or MAY/MUST teaches
